...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    IDENTIFIER_PREC = 310,         /* IDENTIFIER_PREC  */
    EXPR_AS_STATEMENT = 311,       /* EXPR_AS_STATEMENT  */
    LOOP_PREC = 312,               /* LOOP_PREC  */
    UMINUS = 313,                  /* UMINUS  */
    CALL_PREC = 314,               /* CALL_PREC  */
    STRUCT_LIT_NAMED_FIELD = 315   /* STRUCT_LIT_NAMED_FIELD  */
  };
